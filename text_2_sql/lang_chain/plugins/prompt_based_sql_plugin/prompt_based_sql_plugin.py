...
class PromptBasedSQLPlugin:
    ...
    async def get_entity_schema(self, entity_name: str) -> str:
...
#     template="Get the schema for the entity {entity_name}."
# )
# chain = LLMChain(llm=llm, prompt=prompt_template)

# plugin = PromptBasedSQLPlugin(database="your_database")
# entity_name = "your_entity_name"
# schema = await plugin.get_entity_schema(entity_name)
# print(schema)

# sql_query = "SELECT * FROM your_table"
# results = await plugin.run_sql_query(sql_query)
# print(results)